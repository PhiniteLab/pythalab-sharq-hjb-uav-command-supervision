...
If you use this code or its result files, please cite the accompanying arXiv paper:

> M. Iscan and B. Temiz, "Autopilot-Preserving Residual Q-Learning with HJB-Inspired Finite-Action Risk Filtering for Fixed-Wing UAV Command Supervision," arXiv:2606.01397 [cs.RO], 2026. https://arxiv.org/abs/2606.01397

BibTeX:

```bibtex
@article{iscan2026sharqhjb,
  ...
  author  = {Iscan, Mehmet and Temiz, Batuhan},
  journal = {arXiv preprint arXiv:2606.01397},
  year    = {2026},
  doi     = {10.48550/arXiv.2606.01397},
  url     = {https://arxiv.org/abs/2606.01397}
}
```
